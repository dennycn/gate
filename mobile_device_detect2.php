...
/*
  @ref:  http://detectmobilebrowsers.mobi	
  @cc 2010-04-12
*/
...
function mobile_device_detect($iphone=true,$android=true,$opera=true,$mobileredirect=false,$desktopredirect=false){
	...
	// TODO: add by denny, 2013-7-22
	ob_start(); //打开缓冲区，Note: 不起作用，还需修改php.ini的缓冲区开关
...
//mobile_device_detect(true, true, true, "http://www.3g.cn/", "http://www.kuqin.com/");
